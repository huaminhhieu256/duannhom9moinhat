...
<body>
    ...
    <img src="images/anhlogo.png" alt="Website Logo" style="height: 50px;">
</a>
         ...
         <div id="carouselExample" class="carousel slide mt-3" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/slide.jpg" class="d-block w-100" alt="Slide 1">
                ...
                <div class="carousel-item active">
    <img src="images/slide4.jpg" class="d-block w-100" alt="Slide 3">
    <div class="carousel-caption d-none d-md-block">
        <h5>Chào mừng đến ANVATONLINE</h5>
        <p>Đặt món ăn vặt yêu thích của bạn ngay hôm nay!</p>
    </div>
